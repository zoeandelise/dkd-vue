    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['manage:running:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['manage:running:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['manage:running:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listRunning, getRunning, delRunning, addRunning, updateRunning } from "@/api/manage/running";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        innerCode: [
          { required: true, message: "售货机编号不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listRunning(this.queryParams).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除出货流水编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('manage/running/export', {
        ...this.queryParams
